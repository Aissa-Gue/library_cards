...
foreach ($objExcel->getWorksheetIterator() as $worksheet) {
    ...
    for ($row = 2; $row <= $highestrow; $row++) {
        ...
        if ($stud_id != '') {
            //students table
            $insertqry = "INSERT INTO `students` VALUES ('$stud_id', '$soft_id', '$lname', '$fname','$father', '$grandpa','$birthdate','$birthplace', '$wali_lname', '$wali_fname', '$kinship', '$job', '$cultural_level', '$establishment', '$address', '$engagement_date', '$last_edit', '$phone', '$wali_phone', '$notes', '$sex')";
